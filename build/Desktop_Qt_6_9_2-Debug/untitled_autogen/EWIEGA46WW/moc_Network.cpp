...
template <> constexpr inline auto networkStats::qt_create_metaobjectdata<qt_meta_tag_ZN12networkStatsE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SignalData<void(QString, QString, QString, QString)>(5, 2, QMC::AccessPublic, QMetaType::Void, {{
...
void networkStats::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->updatedThroughput((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[2]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (networkStats::*)(QString , QString )>(_a, &networkStats::updatedThroughput, 0))
            return;
...
// SIGNAL 0
void networkStats::updatedThroughput(QString _t1, QString _t2)
{
