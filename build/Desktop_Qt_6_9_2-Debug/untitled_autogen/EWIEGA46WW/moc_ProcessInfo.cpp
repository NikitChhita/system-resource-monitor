...
template <> constexpr inline auto ProcessInfo::qt_create_metaobjectdata<qt_meta_tag_ZN11ProcessInfoE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        ...
        "processesUpdated",
        "",
        "std::vector<ProcessUsage>",
        "processes",
        "updateProcessInfo"
    };

    QtMocHelpers::UintData qt_methods {
        // Signal 'processesUpdated'
        QtMocHelpers::SignalData<void(std::vector<ProcessUsage>)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 3, 4 },
        }}),
        // Slot 'updateProcessInfo'
...
void ProcessInfo::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->processesUpdated((*reinterpret_cast< std::add_pointer_t<std::vector<ProcessUsage>>>(_a[1]))); break;
        case 1: _t->updateProcessInfo(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (ProcessInfo::*)(std::vector<ProcessUsage> )>(_a, &ProcessInfo::processesUpdated, 0))
            return;
    }
}
...
// SIGNAL 0
void ProcessInfo::processesUpdated(std::vector<ProcessUsage> _t1)
{
